...
//
//class CalculationServiceTest : ShouldSpec({
//    val voxelLength = 0.01
//    val calculationService = CalculationService(
//        mockk(),
//        ConductionCalculator(voxelLength),
//        ConvectionCalculator(voxelLength, 273.15),
//        BurningCalculator(voxelLength),
//        mockk(),
//        SmokeCalculator(),
//        timeStep = 0.5,
//        mockk(),
...
//
//        // WHEN
//        val result = calculationService.calculateAllDataFetched(current, neighbours, 0, 0.5, mutableSetOf())
//        //then
//        result shouldBe 0
//    }
//
...
//
//        // WHEN
//        val result = calculationService.calculateAllDataFetched(current, neighbours, 0.5, mutableSetOf())
//        //then
