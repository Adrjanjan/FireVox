...
class SmokeCalculator {
    ...
    fun calculate(voxel: VoxelState, neighbours: List<VoxelState>, timeStep: Double, iteration: Int): Double {
        ...
        for (n in neighbours) {
            ...
            if (n.key.isBelow(voxel.key) && n.material.voxelMaterial == VoxelMaterial.FLAME) {
                // smoke is generated by flame
                gainedSmoke += generatedSmoke(n)
                lostSmoke += 0.0
            } else {
    ...
    private fun generatedSmoke(n: VoxelState): Double {
        return (1 - n.smokeConcentration) / 6 // TODO
    }
